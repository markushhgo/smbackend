...
param apiAppSettings object = {
  ...
  ALLOWED_HOSTS: '${apiWebAppName}.azurewebsites.net,127.0.0.1,localhost,partheite.haltu.net,tkuapp226,kehityspalvelukartta-api.turku.fi,kehityspalvelukartta.turku.fi'
